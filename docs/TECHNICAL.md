...
- [Overview](#overview)
- [Modules](#modules)
  - [1. etl_custom_forms — Deferred Item Creation](#1-etl_custom_forms--deferred-item-creation)
    - [Routing](#routing)
  ...
  - [2. etl_calendar — Interactive Learning Calendar](#2-etl_calendar--interactive-learning-calendar)
    - [Routing and Theming](#routing-and-theming)
    - [Data Query](#data-query)
    - [Event Classification](#event-classification)
    - [JavaScript Integration](#javascript-integration)
  - [3. etl_progress — Learning Progress Dashboard](#3-etl_progress--learning-progress-dashboard)
    - [Data Collection](#data-collection)
    - [Completion Metric](#completion-metric)
    - [Visualizations](#visualizations)
  - [4. etl_chatbot — Floating Assistant](#4-etl_chatbot--floating-assistant)
    - [UI Injection](#ui-injection)
    - [AJAX Endpoint](#ajax-endpoint)
    - [Query Routing](#query-routing)
    - [Performance Strategy](#performance-strategy)
    - [Frontend Behaviour](#frontend-behaviour)
  - [5. etl_deferred_item — Domain Module](#5-etl_deferred_item--domain-module)
    - [Routing and Access](#routing-and-access)
    - [Status Transitions](#status-transitions)
    - [Custom Entity: reflection_log](#custom-entity-reflection_log)
    - [Reflection Form](#reflection-form)
    - [Queue-Based Reminder System](#queue-based-reminder-system)
    - [Automated Testing](#automated-testing)
  - [6. demo — CRUD Learning Module](#6-demo--crud-learning-module)
    - [Database Schema](#database-schema)
    - [CRUD Routes](#crud-routes)
- [Cross-Cutting Design Patterns](#cross-cutting-design-patterns)
  - [Drupal JS Settings Bridge](#drupal-js-settings-bridge)
  - [Drupal Behaviors + .once()](#drupal-behaviors--once)
  - [Two-Pass Conflict Detection](#two-pass-conflict-detection)
  - [Query Reuse via clone](#query-reuse-via-clone)
  - [Output Sanitization](#output-sanitization)
  - [Revision Table Queries](#revision-table-queries)
